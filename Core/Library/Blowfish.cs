...
namespace L2Apf.Library
{
	...
	{
		private static readonly uint[] KP = {0x243F6A88, 0x85A308D3, 0x13198A2E, 0x03707344, 0xA4093822,
										0x299F31D0, 0x082EFA98, 0xEC4E6C89, 0x452821E6, 0x38D01377,
										0xBE5466CF, 0x34E90C6C, 0xC0AC29B7, 0xC97C50DD, 0x3F84D5B5,
										0xB5470917, 0x9216D5D9, 0x8979FB1B};
		private static readonly uint[] KS0 = {0xD1310BA6, 0x98DFB5AC, 0x2FFD72DB, 0xD01ADFB7, 0xB8E1AFED,
										...
										0x6E85076A};
		private static readonly uint[] KS1 = {0x4B7A70E9, 0xB5B32944, 0xDB75092E, 0xC4192623, 0xAD6EA6B0,
										...
										0xDB83ADF7};
		private static readonly uint[] KS2 = {0xE93D5A68, 0x948140F7, 0xF64C261C, 0x94692934, 0x411520F7,
										...
										0x406000E0};
		private static readonly uint[] KS3 = {0x3A39CE37, 0xD3FAF5CF, 0xABC27737, 0x5AC52D1B, 0x5CB0679E,
		...
		public BlowfishEngine(byte[] key)
		{
			...
			*/
			...
			Array.Copy(KS0, S0, SBOX_SK);
			Array.Copy(KS1, S1, SBOX_SK);
			Array.Copy(KS2, S2, SBOX_SK);
			Array.Copy(KS3, S3, SBOX_SK);
			Array.Copy(KP, P, P_SZ);
		...
		public byte[] Encrypt(byte[] input)
		{
			...
			for (uint i = 0; i < input.Length; i += BLOCK_SIZE)
